...
{
    public record GetCarFilterDto(string? CarColor, string CarEngineCapacity, string CarFuelType, string CarManuFacYear, int? CarSeating, int? CarTypeId, int? CompanyId, decimal? MinPrice, decimal? MaxPrice, string? CarCompanyName, string? CarModel);
